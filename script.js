...
/* ----- TYPING EFFECT ----- */
 var typingEffect = new Typed(".typedText",{
    strings : ["Engineer","Programmer","Developer"],
    loop : true,
    typeSpeed : 90, 
    backSpeed : 50,
    backDelay : 2000
...
function showSkills() {
    skillBars.forEach((bar, index) => {
        let width = skillPercentages[index].innerText;
...
sr.reveal('.skills__subtitle', { delay: 150 });
sr.reveal('.skills__text', { delay: 150 });
sr.reveal('.skills__data', { interval: 150 });
sr.reveal('.skills__img', { origin: 'right', delay: 300 });